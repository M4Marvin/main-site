...
export const about = {
  summary:
    "Full Stack Architect working in Python, FastAPI, React, and distributed systems. Co-architected a production algorithmic trading platform processing 106,185+ TradingView signals and 5,000+ automated trades a day. Built a real-time HTML5 Canvas charting engine from scratch — 11 custom renderers, 60fps. Self-host my own cloud: Git, photos, passwords, monitoring, behind Cloudflare tunnels. Mentored 50+ students and 6 engineers, and grew a university CS community from 50 to 250+.",
}
